...
|---|---|---|---|
| `external` | 146 | 23% | anchored outside this build — a red one means the code is wrong |
| `invariant` | 409 | 64% | true by definition or product rule — a red one means the code is wrong |
