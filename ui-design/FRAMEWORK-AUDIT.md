...
| `invariant` | 107 | 45% | true by definition or product rule — a red one means the code is wrong |
| `characterization` | 80 | 34% | froze observed output — protects continuity, not correctness |
| **total** | 237 | | |
<!-- /HYGIENE-COUNTS -->
