...
|---|---|---|---|
| `external` | 46 | 21% | anchored outside this build — a red one means the code is wrong |
| `invariant` | 96 | 43% | true by definition or product rule — a red one means the code is wrong |
| `characterization` | 80 | 36% | froze observed output — protects continuity, not correctness |
| **total** | 222 | | |
<!-- /HYGIENE-COUNTS -->
