...
|---|---|---|---|
| `external` | 50 | 21% | anchored outside this build — a red one means the code is wrong |
| `invariant` | 112 | 46% | true by definition or product rule — a red one means the code is wrong |
