...
|---|---|---|---|
| `external` | 102 | 18% | anchored outside this build — a red one means the code is wrong |
| `invariant` | 398 | 69% | true by definition or product rule — a red one means the code is wrong |
