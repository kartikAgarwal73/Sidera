...
|---|---|---|---|
| `external` | 152 | 20% | anchored outside this build — a red one means the code is wrong |
| `invariant` | 536 | 70% | true by definition or product rule — a red one means the code is wrong |
| `characterization` | 80 | 10% | froze observed output — protects continuity, not correctness |
| **total** | 768 | | |
<!-- /HYGIENE-COUNTS -->
