...
|---|---|---|---|
| `external` | 160 | 21% | anchored outside this build — a red one means the code is wrong |
| `invariant` | 536 | 69% | true by definition or product rule — a red one means the code is wrong |
