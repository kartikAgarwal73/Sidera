...
|---|---|---|---|
| `external` | 116 | 19% | anchored outside this build — a red one means the code is wrong |
| `invariant` | 406 | 67% | true by definition or product rule — a red one means the code is wrong |
