...
|---|---|---|---|
| `external` | 160 | 20% | anchored outside this build — a red one means the code is wrong |
| `invariant` | 549 | 70% | true by definition or product rule — a red one means the code is wrong |
