...
|---|---|---|---|
| `external` | 146 | 22% | anchored outside this build — a red one means the code is wrong |
| `invariant` | 447 | 66% | true by definition or product rule — a red one means the code is wrong |
