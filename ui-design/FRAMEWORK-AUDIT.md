...
|---|---|---|---|
| `external` | 168 | 20% | anchored outside this build — a red one means the code is wrong |
| `invariant` | 583 | 70% | true by definition or product rule — a red one means the code is wrong |
