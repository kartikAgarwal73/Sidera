...
| `invariant` | 65 | 34% | true by definition or product rule — a red one means the code is wrong |
| `characterization` | 80 | 42% | froze observed output — protects continuity, not correctness |
| **total** | 191 | | |
<!-- /HYGIENE-COUNTS -->
